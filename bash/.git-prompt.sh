...
__git_ps1 ()
{
    ...
    local DefaultForegroundColor='\033[m' # Default no color
    local DefaultBackgroundColor=

    local BeforeText=' ['
    local BeforeForegroundColor='\033[1;33m' # Yellow
    local BeforeBackgroundColor=
    local DelimText=' |'
    local DelimForegroundColor='\033[1;33m' # Yellow
    local DelimBackgroundColor=

    local AfterText=']'
    local AfterForegroundColor='\033[1;33m' # Yellow
    local AfterBackgroundColor=

    local BranchForegroundColor='\033[1;36m' # Cyan
    local BranchBackgroundColor=
    local BranchAheadForegroundColor='\033[1;32m' # Green
    local BranchAheadBackgroundColor=
    local BranchBehindForegroundColor='\033[0;31m' # Red
    local BranchBehindBackgroundColor=
    local BranchBehindAndAheadForegroundColor='\033[1;33m' # Yellow
    local BranchBehindAndAheadBackgroundColor=

    local BeforeIndexText=""
    local BeforeIndexForegroundColor='\033[1;32m' # Dark green
    local BeforeIndexBackgroundColor=

    local IndexForegroundColor='\033[1;32m' # Dark green
    local IndexBackgroundColor=

    local WorkingForegroundColor='\033[1;34m' # Blue  #WAS '\033[0;31m' # Dark red
    local WorkingBackgroundColor=

    local UntrackedText=' !'
    local UntrackedForegroundColor='\033[0;31m' # Dark red
    local UntrackedBackgroundColor=

    local StashForegroundColor='\033[0;34m' # Darker blue
